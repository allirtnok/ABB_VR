...
namespace VrPaintAddin
{
    public static class Addin
    {
        ...
        public static void AddinMain()
        {
            ...
            var group = new RibbonGroup(AddinTabGroupId, "VR addin2");
        ...
        static void VrEnvironment_SessionStarted(object sender, EventArgs e)
        {
            ...
            pane.Items.Add(new VrMenuInputModeButton(new ViewTest(), "test"));
            pane.Items.Add(new VrMenuInputModeButton(new SigPos(), "Record"));
